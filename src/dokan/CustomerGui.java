 ...
 * @author Mourad
 */
public class CustomerGui extends Tools{
    ...
    public void display() throws FileNotFoundException, SQLException {
        ...
        submit.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                String message = feedbackt.getText();
                Feedback f = new Feedback();
                f.addFeedback(c.getName(), message, c.getEmail(),c.getID());
        ...
        feedbackt.setStyle("-fx-background-radius:50px;");
...
//        searchfd.setStyle("-fx-border-radius:20px");
        ...
        root.getChildren().addAll(table, sp,table2,sp2);
        // Customer Home
...
//        categorybox.setArcHeight(30);
        ...
        l[7] = new Label("search");

        l[8] = new Label("Logout");
        ...
        l[8].setOnMouseClicked(new EventHandler<Event>() {
